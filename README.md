# 📂 Bruno Fulia — QA Engineer Portfolio

---

## 👋 About Me
I’m **Bruno Fulia**, an **ISTQB-certified QA Engineer** with over **3 years of experience** in **functional, automated, and AI-based testing**.  
I’ve worked on **AI & IoT**, **ERP**, and **LMS** projects — including **QA validation for Samsung Electronics** (Galaxy AI, Bixby, SmartThings).  

💡 **Key Strengths:**  
- AI & LLM model validation  
- Test automation and CI/CD integration  
- Functional and exploratory testing  
- Multilingual and international project experience  

🌐 **Languages:** Spanish, English, French, Italian  

I’m open to **freelance, remote, or full-time QA roles worldwide**, focusing on **functional testing**, **test automation**, and **AI model validation**.

---

## 🧾 CV
You can view or download my full CV on my [personal website](https://brunofulia.netlify.app).
